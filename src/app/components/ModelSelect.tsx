...
const PROVIDER_ICONS = {
  ...
  anthropic: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none">
      ...
      <path d="M12 12L22 7M12 12L2 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
} as const;
...
export default function ModelSelect({
  ...
  useEffect(() => {
    ...
    const checkKeys = () => {
      ...
      setHasKeys(!!anthropicKey || !!openaiKey);
    };
  ...
  const handleProviderChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    } else if (value === 'openai' || value === 'anthropic') {
